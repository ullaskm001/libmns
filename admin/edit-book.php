...
$sql="update  tblbooks set BookName=:bookname,Category=:category,Author=:author,ISBNNumber=:isbn,BookPrice=:price where id=:bookid";
...
<?php 
$bookid=intval($_GET['bookid']);
$sql = "SELECT tblbooks.BookName,tblbooks.Category,tblbooks.Author,tblbooks.ISBNNumber,tblbooks.BookPrice,tblbooks.id as bookid from  tblbooks where tblbooks.id=:bookid";
$query = $dbh -> prepare($sql);
$query->bindParam(':bookid',$bookid,PDO::PARAM_STR);
$query->execute();
